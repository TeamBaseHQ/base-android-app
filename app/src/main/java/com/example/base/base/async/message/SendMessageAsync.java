...
public class SendMessageAsync extends AsyncTask<String, Void, String> {
    ...
    public SendMessageAsync(String teamSlug,String channelSlug,String threadSlug,String content,String type,Context context){
        ...
        this.type = type;
        SendMessageAsync.base = BaseManager.getInstance(context);
    }
    ...
    protected String doInBackground(String... params) {
        //requestHTTP(data);
        try {
            Message message = SendMessageAsync.base.messageService()
                    .createMessage(this.teamSlug, this.channelSlug, this.threadSlug, this.content, this.type);
            return "Message Sent";
