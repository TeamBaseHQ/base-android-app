...
public class TabFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if(choice==0) {
            mTabHost.addTab(mTabHost.newTabSpec("Home").setIndicator("", getResources().getDrawable(R.drawable.home)),
        ...
        mTabHost.addTab(mTabHost.newTabSpec("PersonalMessage").setIndicator("",getResources().getDrawable(R.drawable.personalmessage)),
                PersonalMessageFragment.class, null);

        mTabHost.addTab(mTabHost.newTabSpec("People").setIndicator("",getResources().getDrawable(R.drawable.people)),
