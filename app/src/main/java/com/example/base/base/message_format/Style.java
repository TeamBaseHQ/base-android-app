...
public abstract class Style {
    ...
    protected final int getSystemAccentColor() {
        return getSystemColor(com.stfalcon.chatkit.R.attr.colorAccent);
    }

    protected final int getSystemPrimaryColor() {
        return getSystemColor(com.stfalcon.chatkit.R.attr.colorPrimary);
    }

    protected final int getSystemPrimaryDarkColor() {
        return getSystemColor(com.stfalcon.chatkit.R.attr.colorPrimaryDark);
    }
